...
function App() {
  ...
  return (
    ...
    <div className='bg-pink-400 pb-10'>
      <Header onSearch={handleSearch} />
      <Banner />
      {movieSearch.length > 0 ? (<MovieSearch title={'Kết quả cho tìm kiếm'}
        data={movieSearch} />) : (
        <>
          <MovieList title={"Phim Đặc Sắc"} data={movie} />
          <MovieList title={"Phim Được Đề Cử"} data={movieRate} />
        </>
      )}
    </div>
